...
<template>
    <NuxtLink :to="props.route"
        ...
        <img v-if="props.imageId" class="absolute w-full h-full object-cover top-0 left-0"
        ...
        <div v-if="props.watchPercentage" class="absolute w-full h-1 bg-zinc-400 dark:bg-zinc-900 bottom-0 z-20">
        </div>
        <div v-if="props.watchPercentage" class="absolute w-full h-1 bg-special bottom-0 left-0 z-20"
